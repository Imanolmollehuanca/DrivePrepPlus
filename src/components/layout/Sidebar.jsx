...
import {
  ...
  BarChart2, User, Settings, LogOut,
        ...
        <div className="flex items-center justify-between p-4 lg:p-5 border-b border-white/[0.08]">
          <div className="flex items-center gap-3">
            <div className="sidebar-brand-icon">
              <Car size={20} className="text-sky-400" />
            </div>
            <div>
            ...
            {esPremium ? (
              ...
              <div className="sidebar-premium-card space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] px-1.5 py-0.5 rounded bg-sky-500/20 text-sky-300 font-medium font-display">
                    Gratis
                  </span>
                </div>
        ...
        <div className="sidebar-user-footer">
          <div className="flex items-center gap-3">
            <div className="relative shrink-0">
              <div className="sidebar-avatar font-display font-bold">
                {inicialNombre}
              </div>
