          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-white/10 border border-white/15 backdrop-blur-sm mb-4">
                ...
                <span className="text-[11px] font-bold tracking-wider uppercase text-indigo-200 font-display">
                  Preparación MTC Activa
                </span>
              </div>
              ...
              <p className="text-sm text-indigo-100/90 font-body mt-2 leading-relaxed max-w-md">
            ...
            <div className="relative z-10 mt-6 pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-bold text-white bg-indigo-500 hover:bg-indigo-600 active:scale-[0.98] transition-all shadow-md shadow-indigo-950/40 hover:shadow-lg hover:shadow-indigo-500/30 font-display"
              >
          ...
          >
                ...
                {[
                  {
                    ...
                    iconBg: 'bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 border-indigo-500/30',
                    tileBorder: 'border-indigo-500/20 dark:border-indigo-500/30 hover:border-indigo-500/50',
                    tileBg: 'bg-indigo-500/[0.03] dark:bg-indigo-500/[0.08]',
                  },
                  {
            ...
            <div className="mt-5 pt-4 border-t" style={{ borderColor: 'var(--color-border)' }}>
              <button
                ...
                className="link-action text-xs font-bold inline-flex items-center gap-1.5 hover:gap-2 transition-all font-display"
              >
